...
const CustomImage = (props:ImagePropsCustom) => {
    ...
    propsNew.src = propsNew.src && !hasError ? /https/.test(`${propsNew.src}`) ? propsNew.src : `${process.env.APP_BASE_URL}/files/${props.folderPrefix ? props.folderPrefix + '/' : ''}${propsNew.src}` : '/placeholder.svg';
    propsNew.style = {
        ...propsNew.style,
        objectFit: "cover"
    };
